import { V as VUE_TEMPLATE_NAME, a as vueTemplateAddon, y as VUE_DIRECTIVES_NAME, v as vueDirectivesAddon, q as getMagicString, s as stripCommentsAndStrings, d as RE_MATCH, R as RE_EXCLUDE, c as RE_SEPARATOR, b as RE_IMPORT_AS, g as defineUnimportPreset, t as toExports, u as normalizeImports, j as dedupeImports, n as toTypeDeclarationFile, o as toTypeReExports, k as stripFileExtension, r as addImportToCode } from './unimport.BRHNhdCP.mjs';
...
function resolveGlobsExclude(glob2, cwd) {
  return `${glob2.startsWith("!") ? "!" : ""}${resolve(cwd, glob2.replace(RE_EXCLAMATION_PREFIX, ""))}`;
}
